...
from transformers import AutoTokenizer,pipeline, logging, LlamaTokenizer, LlamaForCausalLM
from auto_gptq import AutoGPTQForCausalLM
from langchain.llms import HuggingFacePipeline
import torch


class WizardVicuna(LLM):
    ...
    def getprompt(self, instruction:str, question:str)-> str:
        prompt = f"{instruction} ### Human: {question} ### Assistant:"
        return prompt
