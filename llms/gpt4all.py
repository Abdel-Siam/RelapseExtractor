...
class Gpt4All(LLM):
    ...
    name = "GPT4All-13B-Snoozy-SuperHOT-8K-GPTQ"
    model_name_or_path = "TheBloke/GPT4All-13B-Snoozy-SuperHOT-8K-GPTQ"
    ...
    def getprompt(self, instruction:str, question:str)-> str:
        return f"### System:{instruction} ### Human: {question} ### Assistant:"
