...
class CAMEL13BHot(LLM):
    
    name = "CAMEL-13B-Combined-Data-SuperHOT-8K-GPTQ"
    model_name_or_path = "TheBloke/CAMEL-13B-Combined-Data-SuperHOT-8K-GPTQ"
    model_basename = "camel-13b-combined-data-superhot-8k-GPTQ-4bit-128g.no-act.order"
