...
class GuanacoHot(LLM):
    
    name = "guanaco-13B-SuperHOT-8K-GPTQ"
    model_name_or_path = "TheBloke/guanaco-13B-SuperHOT-8K-GPTQ"
    model_basename = "guanaco-13b-superhot-8k-GPTQ-4bit-128g.no-act.order"
    ...
    def getprompt(self, instruction:str, question:str)-> str:
        return f"{instruction} ### Human: {question} ### Assistant:"
